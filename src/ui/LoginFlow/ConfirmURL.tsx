...
export interface ConfirmURLProps {
  setRetrievedCode: (retrieved:boolean) => void
  API: APIClient
}

export const ConfirmURL:FC<ConfirmURLProps> = ({ API, setRetrievedCode}) => {
